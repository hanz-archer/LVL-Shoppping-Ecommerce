...
class AddProductForm(forms.ModelForm):
    ...
    life = forms.CharField(widget=forms.TextInput(attrs={'placeholder': "Product Life", "class":"form-control"}))
    mfd = forms.DateTimeField(widget=forms.DateTimeInput(attrs={'placeholder': "e.g 2023-11-15 14:30", "class":"form-control"}))
